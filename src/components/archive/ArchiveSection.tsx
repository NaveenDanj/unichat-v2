    ...
    <div className="w-full h-full">
        ...
        <div>
            ...
            <div className="pt-5 px-8 flex justify-between w-full">
                <h2 className=" font-medium my-auto text-2xl">Archived</h2>
            ...
            <div className="mt-10 px-8 flex justify-between w-full h-16">
                <ThemeProvider theme={darkTheme}>
                    <TextField size="small" placeholder='Search archived' fullWidth className='my-auto  h-24 text-white' id="outlined-basic" variant="outlined" />
                </ThemeProvider>
            </div>
